    ...
    return (
        <>
            ...
            <div className="fixed inset-0 z-[110] flex justify-center pointer-events-none">
                ...
                <div className="flex-1 min-h-0 overflow-y-auto px-panel-gutter py-4 space-y-6 no-scrollbar">
                    ...
                    <div className="flex flex-col">
                        ...
                        <div className="mt-4 flex flex-col items-center justify-center text-center">
                            ...
                            <p className="text-white/30 text-[10px] uppercase font-mono tracking-wider">Build: {process.env.NEXT_PUBLIC_GIT_HASH || 'dev'}</p>
