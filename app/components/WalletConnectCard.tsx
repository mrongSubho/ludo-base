    ...
    return (
        ...
        >
            ...
            <div className="w-20 h-20 mb-6 relative z-10">
                <div className="absolute inset-0 bg-gradient-to-tr from-purple-600 to-teal-400 rounded-3xl opacity-30 blur-lg animate-pulse" />
                <div className="absolute inset-0 bg-gradient-to-tr from-purple-600 to-teal-400 rounded-2xl shadow-[0_0_20px_rgba(99,102,241,0.3)] flex items-center justify-center border border-white/30">
